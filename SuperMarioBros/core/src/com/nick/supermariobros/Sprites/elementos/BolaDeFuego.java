package com.nick.supermariobros.Sprites.elementos;
...
public class BolaDeFuego extends Sprite {
    PlayScreen screen;
    World world;
    ...
    Body b2body;
    public BolaDeFuego(PlayScreen screen, float x, float y, boolean fireRight){
