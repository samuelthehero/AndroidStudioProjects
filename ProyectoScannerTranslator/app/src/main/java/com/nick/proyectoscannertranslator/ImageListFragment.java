...
import com.nick.proyectoscannertranslator.activities.cropperImage.CropperActivity;
import com.nick.proyectoscannertranslator.adapters.AdapterImagen;
import com.nick.proyectoscannertranslator.models.ModelImage;
        ...
        mGetContent = registerForActivityResult(new ActivityResultContracts.GetContent(),
                new ActivityResultCallback<Uri>() {
                    ...
                    public void onActivityResult(Uri result) {
                        Intent intent = new Intent(ImageListFragment.this.getActivity(), CropperActivity.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(itemId == R.id.images_item_delete){
            ...
            builder.setTitle("Eliminar imágenes")
                    ...
                    .setNeutralButton("Eliminar imágenes seleccionadas", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            builder.setTitle("Covertir a PDF")
                    .setMessage("Convertir todas/seleccionadas imagenes a PDF")
                    .setPositiveButton("Convertir todo", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            convertirImagenesAPDF(true);
                        }
                    })
                    .setNeutralButton("Convertir imágen/imagenes seleccionada/as", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(resultCode == -1 && requestCode == 101){
            ...
            if (result != null) {
                ...
                guardarImagenEnDirectorio(resultUri);
            }
        }
    }
