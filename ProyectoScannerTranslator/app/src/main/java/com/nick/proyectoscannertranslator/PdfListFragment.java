...
import com.nick.proyectoscannertranslator.activities.PdfViewActivity;
...
public class PdfListFragment extends Fragment {
    ...
    private void compartirPdf(ModelPdf modelPdf) {
        ...
        // Genera el Uri. Definí la autoridad como el ID de la aplicación en el Manifest. El último parámetro de ese archivo es que el quiero abrir
        Uri uri = FileProvider.getUriForFile(mContext, "com.nick.proyectoscannertranslator.fileprovider", file);
